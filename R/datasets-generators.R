...
#' a \eqn{(d-1)}-sphere in \eqn{\mathbb{R}^d}{R^d}. The user should provide the
#' number of points `n_samples` to be generated on the sphere and the ambient
#' dimension `ambient_dim`. The radius of the sphere is optional and is equal to
#' `1` by default. Only random points generation is currently available.
#'
...
#' generated in \eqn{\mathbb{R}^{2 \mathrm{dim}}}{R^{2 \mathrm{dim}}}. The
#' `sample` argument is optional and is set to `"random"` by default. The
#' generated points are
#' returned as an array of shape \eqn{n_\mathrm{samples} \times \mathbb{R}^{2
#' \mathrm{dim}}}{n_\mathrm{samples} \times R^{2
#' \mathrm{dim}}}.
#'
#' @param n_samples An integer value specifying the sample size.
#' @param dim An integer value specifying the dimension \eqn{\mathbb{R}^{2
#'   \mathrm{dim}}}{R^{2 \mathrm{dim}}} of the torus.
...
#'   \mathrm{dim}}}{n_\mathrm{samples} \times R^{2 \mathrm{dim}}} storing the
#'   sampled points.
#'
#' @export
#' @examplesIf reticulate::py_module_available("gudhi")
