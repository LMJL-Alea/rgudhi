...
#' a \eqn{(d-1)}-sphere in \eqn{\mathbb{R}^d}. The user should provide the
...
#' generated in \eqn{\mathbb{R}^{2 \mathrm{dim}}}. The `sample` argument is
#' optional and is set to `"random"` by default. The generated points are
#' returned as an array of shape \eqn{\mathrm{n_samples} \times \mathbb{R}^{2
#' \mathrm{dim}}}.
#'
#' @param n_samples An integer value specifying the sample size.
#' @param dim An integer value specifying the dimension \eqn{\mathbb{R}^{2
#'   \mathrm{dim}}} of the torus.
